...
public class Dehydration : MonoBehaviour
{
    ...
    void Update(){
        ...
        // Check which InputAction is pressed and enable the Animator accordingly
        if (moveUp.IsPressed()){
            anim.enabled = true; 
        }
            ...
            Vector3 targetPosition = new Vector3(5.95f, 3f, 0f);
            ...
            gameObject.GetComponent<CPR>().enabled = true;
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            gameObject.GetComponent<CPR>().enabled = false;
        }
    }
}
